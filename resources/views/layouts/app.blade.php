            ...
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
                    <div class="logo_laravel">
                        <img src="https://i.pinimg.com/originals/c7/c3/a0/c7c3a029d172b33287003d26a0c693f9.png"
                            alt="" style="width: 150px" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        @auth
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.weapons.index') }}">{{ __('Weapons') }}</a>
                            </li>
                        @else
                            <li class="nav-item">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right nav-dropdown bg-dark"
